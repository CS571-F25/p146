...
export default function ResourceRentalLanding(props) {
  ...
  const [modalVisible, setModalVisible] = useState(!loginStatus);
      ...
      <Row>
        <Col>
          ...
          <p>
            ...
            UW-Madison students. If you are not yet logged in, please do so using the <strong style={{ color: "red" }}>Login</strong> button in the menu above. Additionally,
          ...
          <p>
            ...
            consult with the calendar on the <strong style={{ color: "red" }}>Availability</strong> page to ensure that the item(s) will be available. You will not be allowed
          ...
          <h2>Step 3</h2>
          <p>
            Please navigate to the <strong style={{ color: "red" }}>Catalog</strong> page, where you can search for the item(s) that you would
          ...
          <h2>Step 4</h2>
          <p>
            Ensure that your <strong style={{ color: "red" }}>Cart</strong> contains all of the items you wish to rent; the items in your cart will be the only
            items available for selection when you fill out the Resource Rental Checkout Form
          </p>
          <h2>Step 5</h2>
          <p>
            Complete the Resource Rental <strong style={{ color: "red" }}>Checkout Form</strong>, which will notify us at SOLI of the item that you wish to
